...
import type { BreakPoint } from '@/components/znxj-components/components/grid';
import type { ColumnProps } from './pro-table';
import type { TableProps } from 'element-plus';

import KrSearchForm from '@/components/znxj-components/components/search-form';

import Pagination from './components/Pagination.vue';
import ColSetting from './components/ColSetting.vue';
import TableColumn from './components/TableColumn.vue';
import printJS from 'print-js';
import useTableColSet from '@/components/znxj-components/components/pro-table/src/hooks/use-tableColSet';
...
const clearFilter = () => tableRef.value?.clearFilter(tableColumns.value.map((i) => i.prop as string));
// 表格操作 Hooks
const {
  tableData,
  pageable,
