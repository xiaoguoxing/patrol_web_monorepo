...
Kr Template，基于 Vue3.2、TypeScript、Vite3、Pinia、Element-Plus 开源的一套后台管理模板。

### ？为什么开发这个管理系统 🤷‍♂️

- 快速搭建项目，帮助开发人员快速进入到业务的开发中
- 统一管理系统类项目风格。
...
- GitLab：http://10.11.3.132:8082/ui/ComponentLibrary/tree/dev/libraryWebV2
