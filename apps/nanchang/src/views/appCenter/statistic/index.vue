        ...
        <div class="bottom-left">
          <kr-card header="告警对象" :border="false" class="h100 w100">
            <template #headerRight>
              <el-input
                clearable
                @clear="proTable.getTableList()"
                v-model="tableText"
                style="width: 340px"
                @keydown.enter="proTable.getTableList()"
              ...
              >
                ...
                <template #suffix>
                  <el-icon @click="proTable.getTableList()" style="cursor: pointer"><Search /></el-icon>
                </template>
              </el-input>
            </template>
            <kr-pro-table
...
const initData = async () => {
  loading2.value = true;
  loading3.value = true;
  let newParams = { ...searchParams1.value };
