...
// 今日异常项
export const getTodayCount = (params: any) => {
  return http.get<any>(PORT_INSPECT + `/abnormalItem/getTodayCount`, params);
};
// 今日推送信息数量
export const getTodayXXTSCount = (params: any) => {
  return http.get<any>(PORT_INSPECT + `/alarm/record/home/getTodayQywxCount`, params);
};
// 巡检任务统计
