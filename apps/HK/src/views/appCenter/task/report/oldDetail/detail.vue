...
let formProps: FormProps = [
  { label: '任务名称：', prop: 'inspectionTaskName' },
  {
    label: '任务类型：',
    prop: 'taskTypeName',
  },
...
async function getDetail() {
  if (props.id) {
    ...
    objectList2.value = data.normalList!;
    objectList3.value = data.noDoneList ?? [];
  ...
  <div class="detailPage">
    ...
    <div class="detail-card">
      <div class="detail-card-items">
        <img
          class="detail-card-item-img"
          src="../../../../../assets/images/taskDetail/task_detail1.png"
          alt="巡检项总数量 (个)"
        />
      ...
      <div class="detail-card-items">
        <img
          class="detail-card-item-img"
          src="../../../../../assets/images/taskDetail/task_detail2.png"
          alt="告警项数量 (个)"
        />
        <div class="detail-card-item-info">
      ...
      <div class="detail-card-items">
        <img
          class="detail-card-item-img"
          src="../../../../../assets/images/taskDetail/task_detail3.png"
          alt="正常项数量 (个)"
        />
        <div class="detail-card-item-info">
      ...
      <div class="detail-card-items">
        <img
          class="detail-card-item-img"
          src="../../../../../assets/images/taskDetail/task_detail4.png"
          alt="异常巡检项数量 (个)"
        />
        <div class="detail-card-item-info">
    ...
    <div class="detail-sub-title"><span class="Rect">◆</span>正常项明细</div>
    <div class="detail-table">
      <detailList
        :objectList="objectList2"
        :parentId="id"
        :syncData="formData.syncData"
        :column="resColumnBase"
        :show-btn="false"
        @setDetail="setDetail"
      ></detailList>
    </div>
    <div class="detail-sub-title"><span class="Rect">◆</span>异常巡检项明细</div>
    <div class="detail-table">
      <detailList
